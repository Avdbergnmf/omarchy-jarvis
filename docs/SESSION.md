...
- **Next up: A-029** — recommended depth high (preference memory v0, area:actions; `Blocked-by: none`). A-033 (area:brain) and A-041 (area:overlay) are equally valid disjoint-area alternatives.
...
- [x] A-028 Deterministic candidate-eval foundation — done, merging to main
- [ ] A-041 Agent Monitor redesign — queued (filed; not started)
- [ ] A-029 / A-033 / A-041 — next claimable (all unblocked, disjoint areas)
...
- Report to Alex (done). Next claimable: A-029, A-033, or A-041 (all unblocked, disjoint areas: actions/brain/overlay).
