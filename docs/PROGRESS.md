...
- Evidence: `./scripts/test-full.sh` green — 286 Python tests plus all five JavaScript
  suites, doctor, ShellCheck, coverage/evals/control-plane.
  Log: `logs/tests/full-20260910-183634.log`. This cloud image did not ship `shellcheck`;
