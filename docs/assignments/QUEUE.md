...
**Training track (serial overlay):** A-016 Problems → A-017 Assignments → A-018 Agent monitor (visible Hyprland agent windows + queue board).

**A-015:** Chat overlay plan readability — after Training track unless Alex says otherwise.
