...
| A-035 | Latency distributions, version compare, ledger hooks | done | area:overlay | YES | [done/A-035-latency-distributions-compare-ledger.md](done/A-035-latency-distributions-compare-ledger.md) |
...
| A-044 | Agent manager: Copy handoff fix | done | area:overlay | YES | [done/A-044-agent-copy-handoff-fix.md](done/A-044-agent-copy-handoff-fix.md) |
