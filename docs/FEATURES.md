...
|---|---|---|---|---|
| feat-overlay-chat | Overlay chat and approval | overlay | unvalidated | 0.5.6 |
...
| feat-agent-monitor | Agent monitor: tiles, open window, queue board | overlay | unvalidated | — |
